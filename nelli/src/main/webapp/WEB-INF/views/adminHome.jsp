...
<meta name="keywords"
	content="city informations, Responsive web template, Bootstrap Web Templates, Flat Web Templates, Android Compatible web template, 
		...
		<div id="page-wrapper" class="gray-bg dashbard-1">
			<div class="content-main">
				...
				<div class="banner">
					...
					<h2>
						<a href="#l">Home</a> <i class="fa fa-angle-right"></i> <span>Dashboard</span>
					</h2>
				</div>
				<!--//banner-->
				<!--content-->
